  ...
  return (
    <>
      ...
      <div>
        ...
        <div>
          <Link to='https://salty-coast-36768-7c025fc4e535.herokuapp.com/profile'>freeLances deployed link</Link>
          <Link to='https://github.com/dann9109/freeflow'>Github Repo</Link>
          <img src={coverImage2} className='imageHandler' />
        </div>
        <div>
          <Link to='https://github.com/magellanrose/Recipe_Book_Project'>Github Repo</Link>
